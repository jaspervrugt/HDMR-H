function [ind,nterms,p0] = HDMR_H_F_test(Y,f0,Y_bf,R,alfa,m1,m2,m3,n1, ...
    n2,n3,n,method)
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %
%                                                                         %
...
%                                                                         %
%  SYNOPSIS                                                               %
%   [ind,nterms,p0] = HDMR_H_F_test(Y,f0,Y_bf,R,alfa,m1,m2,m3,n1,n2, ...  %
%       n3,n,method)                                                      %
%                                                                         %
...
switch method
    ...
    case 2 % --> backward elimination of terms (start with Y = f0 + sum(all_terms))
        ...
        for i = 1:n
            ...
            F_stat = ( (SSR0 - SSR1)/(p1 - p0) ) / ( SSR1/(R - p1) );
            % Now calculate critical F value
            F_crit = finv(alfa,p0 - p1,R - p1); % Note 2nd term turned around
