function HDMR_H_plot(SA_sig,Fx,y,y_e,select,p0,iter,id,R,K,refit,maxorder)
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %
%                                                                         %
...
%                                                                         %
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %
% Plots the results of HDMR_H                                             %
%                                                                         %
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %
%                                                                         %
%  SYNOPSIS                                                               %
%   HDMR_H_plot(SA_sig,Fx,y,y_e,select,p0,iter,id,R,K,refit,maxorder)     %
%                                                                         %
...
fprintf('HDMR_H PLOTTING: PLEASE WAIT ...');
...
text(0.3*x_mult,0.6*y_mult,'Visual results of HDMR$_{\rm H}$ toolbox', ...
...
for k = 1 : K
    ...
    if (mod(k,row*col) == 1) || (k == 1)
        figure('units','normalized','outerposition',[0 0 1 1],...
            'name',['HDMR_H: Bivariate scatter plots actual and ' ...
...
if K == 1
    uicontrol(fig,'units','normalized','style', 'text', 'position', ...
        axpos_fig , 'string', ...
        ['Table 1: Properties of HDMR_H emulator, y = f(x), for ' ...
        'training data set (no bootstrapping)'],...
        'fontsize',fontsize_xylabel);
elseif K > 1
    str = strcat(['Table 1: Properties of HDMR_H emulator, y = f(x), ' ...
...
if K == 1
    uicontrol(fig,'units','normalized','style', 'text', 'position', ...
        axpos_table , 'string', ...
        ['Table 2: HDMR_H results for significant model components ' ...
        'only using all X and Y data (no bootstrapping)'],...
        'fontsize',fontsize_xylabel);
elseif K > 1
    str = strcat(['Table 2: HDMR_H results for significant model ' ...
