...
%<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
%               NOW RUN HDMR_H CODE FOR EACH SIMULATION TIME
%<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>

options = struct('graphics',1, ...      % Specify HDMR_H options
...
for k = 1:K                             % Loop over each species    
    for m = 1:3                         % Loop over each summary metric
       [S,Ss,Fx,Em,XY] = ...            % Run HDMR_H toolbox 
           HDMR_H(X,Y,options);         % Need to downselect Y!
    end
end
%<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
